...
class EnumTypeRegistryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testItRegistersAutoloaderDuringInstantiation()
    {
        ...
        new EnumTypeRegistry($this->generator, $this->storage);
    ...
    {
        $this->setExpectedException(EnumException::class, 'Enum type name contains invalid characters. Only letters, numbers and underscores are allowed.');
    ...
    {
        $this->setExpectedException(EnumException::class, 'test\Enum\Fixtures\NotEnum is not a valid enum class.');
